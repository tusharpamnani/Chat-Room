...
function init() {
  ...
  addRoom("timepass");
  changeRoom("lobby");
  addMessage("lobby", "TCB", "Hey! Open another browser tab, send a message.", true);
  addMessage("timepass", "TCB", "This is another room. Neat, huh?", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room, "TCB", `Look, your own "${room}" room! Nice.`, true);
  })
